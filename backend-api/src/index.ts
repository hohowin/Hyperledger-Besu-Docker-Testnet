...
const chain = new MockMiddlewareChainService(MOCK_MIDDLEWARE_URL, loadWalletAddressesFromEnv(process.env));
...
const app = createServer({ chain, compliance, transferService, auditLog, explorer });
